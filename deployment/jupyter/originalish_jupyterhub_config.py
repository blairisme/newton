...
cmd_subfolder = path.realpath(path.abspath(path.join(path.split(inspect.getfile( inspect.currentframe() ))[0],"jwtauthenticator")))
...
#c.Authenticator.whitelist = {'foo', 'test', 'admin'}
