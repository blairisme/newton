...
public class UserRepositoryTest
{
    ...
    public void getUserTest() {
        User expected = new User(1, "user", "user@ucl.ac.uk", UserRole.USER);
    ...
    public void findUserTest() throws Exception{
        User user1 = new User("Foo A", "foo.a@ucl.ac.uk", UserRole.ADMIN);
        User user2 = new User("Foo B", "foo.b@ucl.ac.uk", UserRole.USER);
        User user3 = new User("Bar A", "bar.a@ucl.ac.uk", UserRole.ADMIN);
        User user4 = new User("Bar B", "bar.b@ucl.ac.uk", UserRole.USER);
    ...
    public void addUserTest() {
        User expected = new User("test1", "test1@ucl.ac.uk", UserRole.ORGANISATIONLEAD);
    ...
    public void removeUserTest() {
        User user = new User("test2", "test2@ucl.ac.uk", UserRole.USER);
