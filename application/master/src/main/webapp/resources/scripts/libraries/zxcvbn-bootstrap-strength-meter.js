(function ($) {
    ...
    $.fn.zxcvbnProgressBar = function (options) {
        ...
        var settings = $.extend({
            ...
            allProgressBarClasses: "progress-bar bg-danger bg-warning bg-success progress-bar-striped",
            //bootstrap css classes (0-4 corresponds with zxcvbn score)
            progressBarClass0: "progress-bar bg-danger progress-bar-striped",
            progressBarClass1: "progress-bar bg-danger progress-bar-striped",
            progressBarClass2: "progress-bar bg-warning progress-bar-striped",
            progressBarClass3: "progress-bar bg-success progress-bar-striped",
            progressBarClass4: "progress-bar bg-success progress-bar-striped"
        }, options);
