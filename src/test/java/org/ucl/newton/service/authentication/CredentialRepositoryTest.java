...
public class CredentialRepositoryTest
{
    ...
    public void getCredentialByIdTest() {
        Credential expected = new Credential(0, 0, "user", "$2a$10$jECDv6NZWiMz2k9i9Fw50u5TW3Q4xZ8/gXCc86Q6lZ5.k9A2YrF7m");
        Credential actual = repository.getCredentialById(0);
    ...
    public void addCredentialTest() {
        Credential expected = new Credential(1, 1, "user1", "$2a$10$jECDv6NZWiMz2k9i9Fw50u5TW3Q4xZ8/gXCc86Q6lZ5.k9A2YrF7m");
    ...
    public void removeCredentialTest() {
        Credential credential = new Credential(2, 2, "user2", "$2a$10$jECDv6NZWiMz2k9i9Fw50u5TW3Q4xZ8/gXCc86Q6lZ5.k9A2YrF7m");
